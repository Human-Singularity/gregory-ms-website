...
const CATEGORIES = [
	...
	{ tags:['cell therapy','stem cells','immune reconstitution'], id: 9, name: 'Stem Cells', slug: 'stem-cells', description: 'Stem Cell Research and Autologous Hematopoietic Stem Cell Transplantation (aHSCT)', category_description: 'Stem Cell Research and Autologous Hematopoietic Stem Cell Transplantation (aHSCT)\n\nResearch areas include stem cell therapy, autologous hematopoietic stem cell transplantation, and related regenerative medicine approaches for multiple sclerosis treatment.' },
