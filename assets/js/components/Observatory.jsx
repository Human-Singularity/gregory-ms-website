...
const CATEGORIES = [
  { tags:[], id: 30, name: 'aHSCT', slug: 'ahsct', description: 'Autologous hematopoietic stem cell transplantation research and clinical trials.' },
  { tags:[], id: 1, name: 'Alemtuzumab', slug: 'alemtuzumab', description: 'Research on Alemtuzumab (Lemtrada) for treating relapsing forms of multiple sclerosis.' },
  { tags:[], id: 37, name: 'Teriflunomide', slug: 'teriflunomide', description: 'Studies on Aubagio (teriflunomide) for relapsing-remitting multiple sclerosis.' },
  { tags:[], id: 43, name: 'Monomethyl Fumarate', slug: 'monomethyl-fumarate', description: 'Research on Bafiertam (monomethyl fumarate) for multiple sclerosis treatment.' },
  ...
  { tags:[], id: 38, name: 'Mitoxantrone', slug: 'mitoxantrone', description: 'Research on Novantrone (mitoxantrone) for multiple sclerosis treatment.' },
  ...
  { tags:[], id: 36, name: 'Dimethyl Fumarate', slug: 'dimethyl-fumarate', description: 'Studies on Tecfidera (dimethyl fumarate) for relapsing-remitting multiple sclerosis.' },
  ...
  { tags:[], id: 42, name: 'Diroximel Fumarate', slug: 'diroximel-fumarate', description: 'Research on Vumerity (diroximel fumarate) for multiple sclerosis treatment.' }
];
