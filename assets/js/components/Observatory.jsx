...
const CATEGORIES = [
  { tags:['immune reconstitution'], id: 30, name: 'aHSCT', slug: 'ahsct', description: 'Autologous hematopoietic stem cell transplantation research and clinical trials.' },
  { tags:['immune reconstitution'], id: 1, name: 'Alemtuzumab', slug: 'alemtuzumab', description: 'Research on Alemtuzumab (Lemtrada) for treating relapsing forms of multiple sclerosis.' },
  { tags:[], id: 37, name: 'Aubagio', slug: 'aubagio', description: 'Studies on Aubagio (teriflunomide) for relapsing-remitting multiple sclerosis.' },
  { tags:[], id: 43, name: 'Bafiertam', slug: 'bafiertam', description: 'Research on Bafiertam (monomethyl fumarate) for multiple sclerosis treatment.' },
  ...
  { tags:['BTKi'], id: 50, name: 'Bruton Tyrosine Kinase', slug: 'btk-inhibitors', description: 'BTK inhibitors research for multiple sclerosis treatment.' },
  { tags:[], id: 49, name: 'CAR-T', slug: 'car-t', description: 'CAR-T cell therapy research for multiple sclerosis treatment.' },
  { tags:[], id: 3, name: 'Cladribine', slug: 'cladribine', description: 'Research on Cladribine (Mavenclad) for multiple sclerosis treatment.' },
  ...
  { tags:[], id: 35, name: 'Fingolimod', slug: 'fingolimod', description: 'Research on Fingolimod (Gilenya) for relapsing-remitting multiple sclerosis.' },
  { tags:['DMTs'], id: 32, name: 'Foralumab', slug: 'foralumab', description: 'Studies on Foralumab for multiple sclerosis treatment.' },
  ...
  { tags:['remyelination'], id: 76, name: 'GSK239512', slug: 'gsk239512', description: 'Studies on GSK239512 H3 histamine receptor antagonist for remyelination.' },
  { tags:['remyelination'], id: 77, name: 'Ibudilast (MN-166)', slug: 'ibudilast-mn-166', description: 'Research on Ibudilast as a PDE4 inhibitor for neuroprotection and remyelination.' },
  ...
  { tags:['remyelination'], id: 4, name: 'Metformin', slug: 'metformin', description: 'Research on Metformin as a metabolic modulator for rejuvenating oligodendrocyte precursor cells.' },
  ...
  { tags:[], id: 38, name: 'Novantrone', slug: 'novantrone', description: 'Research on Novantrone (mitoxantrone) for multiple sclerosis treatment.' },
  ...
  { tags:[], id: 29, name: 'Ofatumumab', slug: 'ofatumumab', description: 'Research on Ofatumumab (Kesimpta) for multiple sclerosis treatment.' },
  { tags:['remyelination'], id: 72, name: 'Opicinumab (BIIB033)', slug: 'opicinumab-biib033', description: 'Studies on Opicinumab anti-LINGO-1 antibody for remyelination.' },
  { tags:[], id: 40, name: 'Ozanimod', slug: 'ozanimod', description: 'Research on Ozanimod (Zeposia) for multiple sclerosis treatment.' },
  { tags:['remyelination'], id: 51, name: 'PIPE-307', slug: 'pipe-307', description: 'Studies on PIPE-307 for enhancing myelin repair in multiple sclerosis.' },
  { tags:[], id: 41, name: 'Ponesimod', slug: 'ponesimod', description: 'Research on Ponesimod (Ponvory) for multiple sclerosis treatment.' },
  { tags:['remyelination'], id: 73, name: 'rHIgM22', slug: 'rhigm22', description: 'Studies on rHIgM22 human IgM antibody for remyelination.' },
  { tags:[], id: 28, name: 'Rituximab', slug: 'rituximab', description: 'Research on Rituximab monoclonal antibody for multiple sclerosis treatment.' },
  ...
  { tags:[], id: 10, name: 'Siponimod', slug: 'siponimod', description: 'Studies on Siponimod (Mayzent) for secondary progressive multiple sclerosis.' },
  { tags:[], id: 8, name: 'Tcelna', slug: 'tcelna', description: 'Research on Tcelna for multiple sclerosis treatment.' },
  { tags:[], id: 36, name: 'Tecfidera', slug: 'tecfidera', description: 'Studies on Tecfidera (dimethyl fumarate) for relapsing-remitting multiple sclerosis.' },
  { tags:['BTKi'], id: 34, name: 'Tolebrutinib', slug: 'tolebrutinib', description: 'Research on Tolebrutinib BTK inhibitor for multiple sclerosis treatment.' },
  { tags:[], id: 39, name: 'Ublituximab', slug: 'ublituximab', description: 'Studies on Ublituximab (Briumvi) for relapsing multiple sclerosis.' },
  { tags:[], id: 42, name: 'Vumerity', slug: 'vumerity', description: 'Research on Vumerity (diroximel fumarate) for multiple sclerosis treatment.' }
];
